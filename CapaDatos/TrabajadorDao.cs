...
namespace CapaDatos
{
    public class TrabajadorDao
    {
        ...
        public DataTable ListarTrabajador(int id_departamento)
        {
            DataTable tabla = new DataTable();
            SqlDataReader leer;
            SqlCommand cmd = new SqlCommand("SP_LISTAR_TRABAJADORES_DEPARTAMENTO_", connection);
        ...
        public DataTable BuscarTrabajador(TrabajadorModel trabajador)
        {
            ...
            SqlCommand cmd = new SqlCommand("SP_BUSCAR_TRABAJADOR2", connection);
            cmd.CommandType = CommandType.StoredProcedure;
            connection.Open();
